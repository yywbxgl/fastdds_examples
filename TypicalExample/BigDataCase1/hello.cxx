...
HelloMsg::HelloMsg()
{
    ...
    memset(&m_data, 0, (100*1024*1024) * 1);
        ...
        size_t current_alignment)
{
    ...
    current_alignment += ((100*1024*1024) * 1) + eprosima::fastcdr::Cdr::alignment(current_alignment, 1);
 ...
 */
const std::array<char, 100*1024*1024>& HelloMsg::data() const
{
    return m_data;
}
 ...
 */
std::array<char, 100*1024*1024>& HelloMsg::data()
{
    return m_data;
}
