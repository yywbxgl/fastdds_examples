...
{
    // m_Second com.eprosima.idl.parser.typecode.PrimitiveTypeCode@192d3247
    m_Second = 0;
    // m_Millisecond com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3ecd23d9
    m_Millisecond = 0;
    // m_Nanoseconds com.eprosima.idl.parser.typecode.PrimitiveTypeCode@569cfc36
    m_Nanoseconds = 0;
...
{
    // m_TriggerTimeStamp com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@d6da883

    // m_ChnTimeStamp com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@d6da883

    // m_Vaild com.eprosima.idl.parser.typecode.PrimitiveTypeCode@45afc369
    m_Vaild = false;
    // m_CameraID com.eprosima.idl.parser.typecode.PrimitiveTypeCode@799d4f69
    m_CameraID = 0;
    // m_ColorSpace com.eprosima.idl.parser.typecode.PrimitiveTypeCode@49c43f4e
    m_ColorSpace = 0;
    // m_Width com.eprosima.idl.parser.typecode.PrimitiveTypeCode@290dbf45
    m_Width = 0;
    // m_Height com.eprosima.idl.parser.typecode.PrimitiveTypeCode@12028586
    m_Height = 0;
    // m_Size com.eprosima.idl.parser.typecode.PrimitiveTypeCode@17776a8
    m_Size = 0;
    // m_Format com.eprosima.idl.parser.typecode.PrimitiveTypeCode@69a10787
    m_Format = 0;
    // m_Offset com.eprosima.idl.parser.typecode.PrimitiveTypeCode@11c20519
    m_Offset = 0;
    // m_Bits com.eprosima.idl.parser.typecode.ArrayTypeCode@70beb599
...
{
    // m_GroupTimeStamp com.eprosima.fastdds.idl.parser.typecode.StructTypeCode@d6da883

    // m_FrameIdx com.eprosima.idl.parser.typecode.PrimitiveTypeCode@58134517
    m_FrameIdx = 0;
    // m_FrameVector com.eprosima.idl.parser.typecode.SequenceTypeCode@4450d156

    // m_str_test com.eprosima.idl.parser.typecode.StringTypeCode@4461c7e3
    m_str_test ="";
        ...
        GroupFrame&& x) noexcept 
{
    ...
    m_str_test = std::move(x.m_str_test);
}
        ...
        const GroupFrame& x) const
{
    ...
    return (m_GroupTimeStamp == x.m_GroupTimeStamp && m_FrameIdx == x.m_FrameIdx && m_FrameVector == x.m_FrameVector && m_str_test == x.m_str_test);
}
        ...
        size_t current_alignment)
{
    ...
    current_alignment += 4 + eprosima::fastcdr::Cdr::alignment(current_alignment, 4) + data.str_test().size() + 1;
...
/*!
 * @brief This function copies the value in member str_test
 * @param _str_test New value to be copied in member str_test
 */
void joyson::sensor::camera::GroupFrame::str_test(
        const std::string& _str_test)
{
    m_str_test = _str_test;
}

/*!
 * @brief This function moves the value in member str_test
 * @param _str_test New value to be moved in member str_test
 */
void joyson::sensor::camera::GroupFrame::str_test(
        std::string&& _str_test)
{
    m_str_test = std::move(_str_test);
}

/*!
 * @brief This function returns a constant reference to member str_test
 * @return Constant reference to member str_test
 */
const std::string& joyson::sensor::camera::GroupFrame::str_test() const
{
    return m_str_test;
}

/*!
 * @brief This function returns a reference to member str_test
 * @return Reference to member str_test
 */
std::string& joyson::sensor::camera::GroupFrame::str_test()
{
    return m_str_test;
}
