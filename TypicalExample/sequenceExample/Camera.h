    ...
    namespace sensor {
        namespace camera {
            ...
            public:
                 ...
                 */
                eProsima_user_DllExport void str_test(
                 ...
                 */
                eProsima_user_DllExport const std::string& str_test() const;

                /*!
                 * @brief This function returns a reference to member str_test
                 * @return Reference to member str_test
                 */
                eProsima_user_DllExport std::string& str_test();
