...
bool helloSubscriber::init(int domain_id, std::string part)
{
    ...
    SubscriberQos sqos;
    // sqos.partition().push_back(part.c_str());
...
{
    std::cout << "on_sample_lost .total count=" << status.total_count  
        << "  total count change= "<< status.total_count_change << std::endl;
}
