...
public:
     ...
     */
    eProsima_user_DllExport void sensor_data(
     ...
     */
    eProsima_user_DllExport const std::string& sensor_data() const;

    /*!
     * @brief This function returns a reference to member sensor_data
     * @return Reference to member sensor_data
     */
    eProsima_user_DllExport std::string& sensor_data();
