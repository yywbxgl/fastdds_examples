...
#ifndef _FAST_DDS_GENERATED_HELLO_PUBLISHER_H_
#define _FAST_DDS_GENERATED_HELLO_PUBLISHER_H_
...
public:
    ...
    bool init(int domain_id, std::string part);
...
#endif // _FAST_DDS_GENERATED_HELLO_PUBLISHER_H_