        ...
        char** argv)
{
    ...
    switch (type)
    {
        ...
        case 2:
        {
            helloSubscriber mysub;
            if (mysub.init(data_share_flag))
            {
                mysub.run();
            }
            break;
