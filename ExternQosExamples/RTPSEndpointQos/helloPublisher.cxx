...
bool helloPublisher::init(int flag)
{
    ...
    // flow_control_300k_per_sec->max_bytes_per_period = 1000 * 1000;
    ...
    wqos.endpoint().unicast_locator_list.push_back(new_unicast_locator);
    ...
    wqos.endpoint().external_unicast_locators[1][0].push_back(external_locator);
    // Drop non matching locators
    wqos.endpoint().ignore_non_matching_locators = true;
    //Set 3 as user defined id
    wqos.endpoint().user_defined_id = 3;
    //Set 4 as entity id
    wqos.endpoint().entity_id = 4;
