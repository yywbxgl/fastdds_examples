...
bool helloPublisher::init(int flag)
{
    ...
    if (flag == 0) {
        // This controller allows 1000kb per second.
        // ThroughputControllerDescriptor slowPublisherThroughputController{1000000, 1000};
        // wqos.throughput_controller() = slowPublisherThroughputController;
        wqos.publish_mode().flow_controller_name = flow_controller_name;
    } else {
        wqos.publish_mode().flow_controller_name = FASTDDS_FLOW_CONTROLLER_DEFAULT;
    }
